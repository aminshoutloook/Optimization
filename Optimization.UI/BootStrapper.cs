...
namespace Optimization.UI
{
    ...
    using Optimization.DbAccess.App_Start;
    using Optimization.Logic.App_Start;
    using Services;
    using ViewModels;
    ...
    public static class BootStrapper
    {
        ...
        public static void Start()
        {
            ...
            builder
    .RegisterType<OptimizationContext>()
    .WithParameter("options", ApplicationDbContextFactory.Get())
    .InstancePerLifetimeScope();

            //-----------------------------
            //Now register the other layers
            builder.RegisterModule(new OptimizationDbAccessModule(false));
            builder.RegisterModule(new OptimizationLogicModule(false));
